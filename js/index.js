...
backgroundColor.addEventListener('click', (e) => {
  backgroundColor.style.background ="aliceblue";
 ...
 backgroundColor.addEventListener('dblclick', (e) => {
  ...
  window.addEventListener("contextmenu", function(x) {
    alert("Right clicking the nav gives you this pop-up!");
  });
  ...
  window.addEventListener("load", function() {
    window.prompt("Welcome to F U N  B U S !! Where would you like to go?");
  });
